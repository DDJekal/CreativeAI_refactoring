    ...
    with st.spinner("🔄 Generiere DALL-E Prompt mit MultiPromptSystem..."):
        try:
            ...
            try:
                ...
                # TODO: REFACTORING - Ersetze MultiPromptSystem durch neue modulare Pipeline
                # Neue Pipeline: creative_core.prompt_composer.compose(layout, design, texts, motive)
                # 
